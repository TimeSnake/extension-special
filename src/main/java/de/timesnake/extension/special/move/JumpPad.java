...
public class JumpPad extends Mover {
  ...
  public JumpPad(MoverManager<JumpPad> manager, ExLocation location, double speed, double x,
      double y, double z) {
    ...
    file.setLocation(MoversManager.getMoverPath(JumpPadManager.NAME, id) + "." + LOCATION,
        this.getLocation(),
        false);
    file.set(MoversManager.getMoverPath(JumpPadManager.NAME, id) + "." + DIRECTION + "." + X,
        this.getX());
    file.set(MoversManager.getMoverPath(JumpPadManager.NAME, id) + "." + DIRECTION + "." + Y,
        this.getY());
    file.set(MoversManager.getMoverPath(JumpPadManager.NAME, id) + "." + DIRECTION + "." + Z,
        this.getZ());
    file.set(MoversManager.getMoverPath(JumpPadManager.NAME, id) + "." + SPEED, this.getSpeed());
    file.save();
  }

  public JumpPad(MoverManager<JumpPad> manager, int id, ExWorld world)
    ...
    this.y = file.getDouble(
        MoversManager.getMoverPath(JumpPadManager.NAME, id) + "." + DIRECTION + "." + Y);
    this.z = file.getDouble(
        MoversManager.getMoverPath(JumpPadManager.NAME, id) + "." + DIRECTION + "." + Z);
    file.save();
  }
